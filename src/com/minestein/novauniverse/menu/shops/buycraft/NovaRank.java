...
public class NovaRank {
    ...
    public static Inventory getInventory() {
        Inventory inventory = Bukkit.createInventory(null, 9, "§e§l>> §b§lNova Rank");
        inventory.setItem(2, getOneMonth());
        inventory.setItem(3, getSixMonth());
        inventory.setItem(4, getTwelveMonth());
        inventory.setItem(5, getLifetime());
        return inventory;
    }
    ...
    public static ItemStack getLifetime() {
        ItemStack lifetime = new ItemStack(Material.EMERALD_BLOCK);
        {
            ItemMeta m = lifetime.getItemMeta();
            m.setDisplayName("§a§lLifetime");
            lifetime.setItemMeta(m);
        }
